...
flag1 = 0
flag2 = 0
#установка режимов пинов как выходов логического сигнала
GPIO.setmode(RPIO.BCM)
GPIO.setup(22, RPIO.OUT)
GPIO.setup(23, RPIO.OUT)
GPIO.setup(17, RPIO.OUT)
GPIO.setup(18, RPIO.OUT)
...
# определение координат белой линии в кадре
 ...
 #проверка позиции барьера: если объект в центре кадра по оси Х, то остановиться и уведомить об остановке
    ...
    GPIO.output(22, flag1) #выставление логических уровней с флагов на пинах
    GPIO.output(23, flag2) #
